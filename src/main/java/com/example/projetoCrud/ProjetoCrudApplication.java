...
public class ProjetoCrudApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Aluno aluno1 = new Aluno(null, "Kelvi Martins Ribeiro", 530333,curso1, 9.5f);		
		
		
		Aluno aluno2 = new Aluno(null, "Vinícius Souza", 603502, curso2, 8.5f);		
		

		Aluno aluno3 = new Aluno(null, "Marcelo Ramos", 703503,  curso3 , 9.5f);		

		Aluno aluno4 = new Aluno(null, "Thaís Almeida", 603503, curso2, 8.5f);		
			

		Aluno aluno5 = new Aluno(null, "Deivisson Martins", 803502,curso4,8.5f);		
		
		Aluno aluno6 = new Aluno(null, "Deivid Ribeiro", 803502, curso4, 7.5f);		
